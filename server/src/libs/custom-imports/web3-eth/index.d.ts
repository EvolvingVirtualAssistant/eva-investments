...
import * as net from 'https://cdn.esm.sh/v58/@types/node/net.d.ts';
import {
  BatchRequest,
  Extension,
  Log,
  ...
  LogsOptions,
  PastLogsOptions,
} from 'https://cdn.esm.sh/v58/web3-core@1.6.1/types/index.d.ts';
import { Subscription } from 'https://cdn.esm.sh/v58/web3-core-subscriptions@1.6.1/types/index.d.ts';
import { AbiCoder } from 'https://cdn.esm.sh/v58/web3-eth-abi@1.6.1/types/index.d.ts';
import { Accounts } from 'https://cdn.esm.sh/v58/web3-eth-accounts@1.6.1/types/index.d.ts';
import {
  Contract,
  ContractOptions,
} from 'https://cdn.esm.sh/v58/web3-eth-contract@1.6.1/types/index.d.ts';
import { Ens } from 'https://cdn.esm.sh/v58/web3-eth-ens@1.6.1/types/index.d.ts';
import { Iban } from 'https://cdn.esm.sh/v58/web3-eth-iban@1.6.1/types/index.d.ts';
import { Personal } from 'https://cdn.esm.sh/v58/web3-eth-personal@1.6.1/types/index.d.ts';
import { Network } from 'https://cdn.esm.sh/v58/web3-net@1.6.1/types/index.d.ts';
import { AbiItem } from 'https://cdn.esm.sh/v58/web3-utils@1.6.1/types/index.d.ts';
import { BigNumber } from 'https://cdn.esm.sh/v58/bignumber.js@9.0.1/bignumber.d.ts';
import BNDefault from 'https://cdn.esm.sh/bn.js?target=deno';

type BN = InstanceType<typeof BNDefault>;
