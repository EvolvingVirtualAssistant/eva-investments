...
export class DeployContractService {
  ...
  private async _deploy(
    ...
    this.web3.setProvider(host); //"http://localhost:8545"
    ...
    const createTransaction = await this.signTransaction(
      deployerAccount,
      contractTx,
      gas,
      gasPrice,
    ...
    return await this.web3.eth.accounts.signTransaction(
      {
        ...
        gas, //750000
        gasPrice: this.web3.utils.toWei(gasPrice, ethereUnit) //1.2444
      },
